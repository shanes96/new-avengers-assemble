...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(UITreeNode, { className: "UITreeNode", filePath: "tree.ts", lineNumber: 180 }); })();
/**
 * Tree is used to display hierarchical data.
 * @group Components
 */
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(Tree, { className: "Tree", filePath: "tree.ts", lineNumber: 801 }); })();
class TreeModule {
